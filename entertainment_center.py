# coding=utf-8
"""
Module that creates instances of Movie classes from media.py contents
"""
...
akira = media.Movie(
    ...
    "member into a rampaging psychic psychopath that only two teenagers"
...
mad_max = media.Movie(
    ...
    " in search for her home-land with the help of a group of"
...
movies = [
    pulp_fiction, star_wars, akira,
    good_will_hunting, blade_runner,
    drive, mad_max, forrest_gump, ex_machina]
# Pass movies array into open_movies_page(movies)
