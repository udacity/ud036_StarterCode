...
dragonballz = media.Movie('DBZ Resurrection of F',
                          'Goku and Vegeta must protect Earth from the resurrected Frieza and his army of soldiers.',
...
den_of_thieves = media.Movie('Den of Thieves',
                             ...
                             'https://i2.wp.com/teaser-trailer.com/wp-content/uploads/Den-of-Thieves-movie-poster-2.jpg?ssl=1',
...
avatar = media.Movie('Avatar',
                     ...
                     'http://cdn1-www.comingsoon.net/assets/uploads/2009/08/file_57684_0_avatarhiresposter.jpg',
                     'https://www.youtube.com/watch?v=5PSNL1qE6VY')

#boruto the movie is an instance of class Movie()
boruto_the_movie = media.Movie('Boruto The Movie',
                               ...
                               'https://vignette.wikia.nocookie.net/naruto/images/5/50/Boruto_the_Movie_poster_2.png/revision/latest?cb=20161117222759',
...
#ninja_assassin is an instance of class Movie ()
ninja_assassin = media.Movie('Ninja Assassin',
                             ...
                             'https://images-na.ssl-images-amazon.com/images/M/MV5BMTcxNDYzMjU1Ml5BMl5BanBnXkFtZTcwMTYzOTM3Mg@@._V1_UY1200_CR90,0,630,1200_AL_.jpg',
                             'https://www.youtube.com/watch?v=NhYH26KTNbQ')

movies = [dragonballz, the_town, den_of_thieves, avatar, boruto_the_movie, hitch, avengers, transformer, ninja_assassin]
